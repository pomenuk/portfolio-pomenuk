...
// Agregar clase activa a enlaces de navegación según la posición de desplazamiento
window.addEventListener('scroll', () => {
...
// Animaciones simples cuando los elementos entran en la vista
...
// Sistema de cambio de fondo cada minuto (integrado desde index.html)
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (backgroundElement) {
        const darkColorPalettes = [
            ...
            // Paleta 5: Rojos oscuros
            'linear-gradient(45deg, #7f1d1d 0%, #991b1b 25%, #b91c1c 50%, #dc2626 75%, #7f1d1d 100%)',
        ...
        // Cambiar fondo cada minuto
        setInterval(changeBackground, 60000); // 60000ms = 1 minuto
    }
    
    // Efecto máquina de escribir con 30 tipografías
...
// Agregar estilos CSS para las animaciones del burger en responsive
